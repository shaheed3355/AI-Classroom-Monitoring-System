...
# LOAD IMAGE
frame = cv2.imread("hod/class3.jpeg")
if frame is None:
...
res_a = yolo_activity(frame, conf=0.08, imgsz=640)
...
cv2.imwrite("final_corrected_classroom.jpg", frame)
print("Output saved as final_corrected_classroom.jpg")